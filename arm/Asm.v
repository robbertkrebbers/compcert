...
Inductive instruction : Type :=
  ...
  | Pbuiltin: builtin -> list preg -> list preg -> instruction  (**r built-in function *)
  | Pannot: builtin -> list annot_param -> instruction (**r annotation statement *)
