...
Proof.
  intros ge.
  assert (LOAD1: forall ch m1 a rs1 rd rs2 m2,
    exec_load ge ch m1 a rs1 rd = Next rs2 m2 -> Mem.forward m1 m2).
  ...
  assert (STORE1: forall ch m1 a s1 rs1 rs rs2 m2,
    exec_store ge ch m1 a s1 rs1 rs = Next rs2 m2 -> Mem.forward m1 m2).
